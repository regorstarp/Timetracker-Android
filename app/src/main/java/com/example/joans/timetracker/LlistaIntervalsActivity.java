...
public class LlistaIntervalsActivity extends AppCompatActivity {
    ...
    private AdapterLlistaIntervals aaAct;
    /**
    ...
    public final void onCreate(final Bundle savedInstanceState) {
        ...
        aaAct = new AdapterLlistaIntervals(this, new ArrayList<Integer>(), new ArrayList<String>(),
                llistaDadesIntervals, new ArrayList<String>());
        intervalsListView.setAdapter(aaAct);
        FloatingActionButton myFAB = (FloatingActionButton) findViewById(R.id.fabAfegirInterval);
        myFAB.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(LlistaIntervalsActivity.this, FormulariAfegirInterval.class);
    ...
    public class Receptor extends BroadcastReceiver {
        ...
        public final void onReceive(final Context context,
            ...
            if (intent.getAction().equals(GestorArbreActivitats.TE_FILLS)) {
                ...
                ArrayList<String> dataInicial = new ArrayList<String>();
                String duradaActivitat ="";
                SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
                for (DadesInterval dadesInter : llistaDadesInter) {
                    imatge.add(R.drawable.interval);
                    //dataInicial.add(dadesInter.getDataInicial());
                    duradaActivitat=dadesInter.toString();
                    dataInicial.add(dateFormat.format(dadesInter.getDataInicial()));
                    durada.add(duradaActivitat.substring(duradaActivitat.indexOf(' ')+4));
                }
                Log.i(tag, durada.toString());
                Log.i(tag, imatge.toString());
                aaAct = new AdapterLlistaIntervals(activity, imatge, durada, llistaDadesInter, dataInicial);
                intervalsListView.setAdapter(aaAct);
