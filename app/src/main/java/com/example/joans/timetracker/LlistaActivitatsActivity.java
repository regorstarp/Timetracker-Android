...
public class LlistaActivitatsActivity extends AppCompatActivity {
     ...
     */
    //private ArrayAdapter<DadesActivitat> aaAct; funciona amb default
    private AdapterLlistaActivitats aaAct;
    ...
    private int layoutID = R.layout.activity_element_llista_activitats;
    /**
    ...
    private class Receptor extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (intent.getAction().equals(GestorArbreActivitats.TE_FILLS)) {
                ...
                Activitat activitatPareActual = (Activitat) intent
                        .getSerializableExtra("activitat_pare");
                if (activitatPareActual.getNom().equals("ARREL")){
                    setTitle("TimeTracker");
                }else{
                    setTitle(activitatPareActual.getNom());
                }
                aaAct.clear();
                //gestio de icone de activitat segons el tipus
                ArrayList<Integer> imatge = new ArrayList<Integer>();
                ArrayList<String> nom = new ArrayList<String>();
                ArrayList<String> durada = new ArrayList<String>();
                ArrayList<Integer> btn = new ArrayList<Integer>();
                String nomActivitat;
                String duradaActivitat;
                for (DadesActivitat dadesAct : llistaDadesActivitats) {
                    nomActivitat = dadesAct.getNom();
                    nom.add(nomActivitat);
                    durada.add(dadesAct.toString());

                    if(dadesAct.isProjecte()){
                        imatge.add(R.drawable.project);
                        btn.add(R.drawable.info);
                    }else if(dadesAct.isTasca()){
                        imatge.add(R.drawable.tasca);
                        if (dadesAct.isCronometreEngegat()){
                            btn.add(R.drawable.pause_circle);
                        }else{
                            btn.add(R.drawable.play_circle);
                        }

                    }
                }
                //aaAct.add(dadesAct); aixo funciona amb el default
                //aaAct.addArrays(nom, imatge);
                aaAct = new AdapterLlistaActivitats(activity, nom, imatge, durada, btn, llistaDadesActivitats);
    ...
    public final void onCreate(final Bundle savedInstanceState) {
        ...
        activitatAccio = (ImageButton) this.findViewById(R.id.btnActivitat);
        llistaDadesActivitats = new ArrayList<DadesActivitat>();
        Log.i(tag, String.valueOf(llistaDadesActivitats.size()));
        //aaAct = new ArrayAdapter<DadesActivitat>(this, layoutID,
        //        llistaDadesActivitats);
        aaAct = new AdapterLlistaActivitats(activity, new ArrayList<String>(), new ArrayList<Integer>(),
                new ArrayList<String>(), new ArrayList<Integer>(), new ArrayList<DadesActivitat>());
        arrelListView.setAdapter(aaAct);
        //arrelListView.setAdapter(aaAct);
        FloatingActionButton myFAB = (FloatingActionButton) findViewById(R.id.fabAfegirActivitat);
        myFAB.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(LlistaActivitatsActivity.this, FormulariAfegirActivitat.class);
